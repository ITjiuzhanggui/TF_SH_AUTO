...
TESTSRC=$(cd ${BASEDIR}/../../sources/1031/boschclustermark/ && pwd)
TESTCMD="cd $(basename ${TESTSRC}) && timeout 60 stdbuf -oL ./boschall-wayland -x 1920 -y 1080 -msaa 2  2>&1 | tee ${JID}.out"
