...
TESTSRC=$(cd ${BASEDIR}/../../sources/1031/citybench/ && pwd)
TESTCMD="cd $(basename ${TESTSRC}) && timeout 60 stdbuf -oL ./citybenchevo-wayland -x 1920 -y 1080 -msaa 2  2>&1 | tee ${JID}.out"
