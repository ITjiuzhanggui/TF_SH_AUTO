...
TESTSRC=$(cd ${BASEDIR}/../../sources/1031/denso/ && pwd)
TESTCMD="cd $(basename ${TESTSRC}) && timeout 60 stdbuf -oL ./denso-wayland -x 1920 -y 1080 -offscreen -ox 1920 -oy 1080 -msaa 2  2>&1 | tee ${JID}.out"
